...
const FirstReview = () => {
  ...
  const handleSupportingChange = (e) => {
    ...
    // Reset input value to allow uploading same file again later if removed
  ...
  const handleSubmit = (e) => {
    ...
    setErrorMessage('');
    alert(`Submitted:
      Presentation File: ${presentationFile ? presentationFile.name : 'None'}
        ...
        <div className="col-12">
          <div className="bg-white p-5 rounded shadow-sm border">
            ...
            <div className="text-center mb-4">
              <h2 className="fw-bold mb-3" style={{ color: '#F4B400' }}>Stage 3: First Review</h2>
              <p className="text-dark mb-0">
                In this stage, please submit your presentation and any supporting documents required for the First Review. You can upload your final presentation file and additional materials (like reports, references, or appendices) that support your project.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              {/* Presentation Upload */}
              <div className="mb-4">
                <label htmlFor="presentationUpload" className="form-label text-dark fw-semibold">
                  Upload Presentation File <span className="text-muted">(PDF/PPT)</span>
                </label>
                <input
                ...
                <div className="mt-2 small text-dark">
                  ...
                  {presentationFile ? presentationFile.name : <span className="text-muted">No file chosen</span>}
                </div>
                {presentationFile && (
                  <button
                    type="button"
              ...
              <div className="mb-4">
                <label htmlFor="supportingUpload" className="form-label text-dark fw-semibold">
                  Upload Supporting Documents <span className="text-muted">(PDF/Images, Multiple Allowed)</span>
                </label>
                <input
                  id="supportingUpload"
                  type="file"
