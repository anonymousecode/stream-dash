...
const IdeaDevelopment = ({ projectId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (conceptFile) {
      concept = await uploadFile(conceptFile, 0);
      console.log("concept URL:", concept);
    }
    if (outlineFile) {
      outline = await uploadFile(outlineFile, 0);
      console.log("outline URL:", outline);
    }
    const form = {
      "idea_development": [
        {

          "brainstorming_map": brainstorm,
          "concept_map": concept,
...
gap-3">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            // onChange={(e) => setConceptFile(e.target.files[0])} 
            />
            {conceptFileName && (
              <div className="alert alert-light border d-flex justify-content-between align-items-center mt-2">
