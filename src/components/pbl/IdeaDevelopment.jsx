    ...
    <div className="container-fluid py-5 px-3">
      <div className="bg-white p-5 rounded shadow-sm border w-100">
        ...
        <div className="text-center mb-4">
          <h2 className="fw-bold mb-3" style={{ color: '#F4B400' }}>Stage 2: Idea Development</h2>
          <p className="text-dark mb-0">
            In this phase, your team will ideate solutions for the problem at hand. This is a critical stage where you’ll explore creative ways to address the challenges you’ve identified. The phase consists of three key steps:
          </p>
          <ul className="text-start mt-3 mb-3">
            <li><strong>Brainstorming:</strong> Generating ideas and potential directions for the project.</li>
            <li><strong>Mind Mapping:</strong> Visualizing your ideas and concepts to explore connections and structure.</li>
            <li><strong>Project Outline:</strong> Drafting a detailed plan for the project, including goals, timelines, and deliverables.</li>
          </ul>
          <p className="text-dark">
            For each of these steps, we provide worksheets to guide your progress. Please make sure to download and complete them before uploading the final versions.
          </p>
        </div>

        {/* Worksheet Download Section */}
        <div className="mb-4">
          <h5 className="fw-semibold text-dark text-center mb-3">Download Worksheets for Guidance</h5>
