        ...
        <>
          ...
          <div className="d-flex justify-content-center mb-3">
            <button
              ...
              style={{
                backgroundColor: filter === "ongoing" ? "#F4B400" : "white",
                color: filter === "ongoing" ? "white" : "#F4B400",
            ...
            <button
              ...
              style={{
                backgroundColor: filter === "completed" ? "#F4B400" : "white",
                color: filter === "completed" ? "white" : "#F4B400",
                border: "1px solid #F4B400",
                margin: "0 10px",
              }}
            >
